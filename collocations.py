...
# return the 10 n-grams with the highest PMIw
finder = BigramCollocationFinder.from_words(nltk.corpus.genesis.words('flixbus_review_filtered_rate_1.txt'))
b = finder.nbest(bigram_measures.pmi, 9999) 
print(b)
